...
import com.fcranchi.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.fcranchi.minhasfinancas.api.dto.LancamentoDTO;
...
import com.fcranchi.minhasfinancas.model.enums.TipoLancamento;
...
public class LancamentoResource {
	...
	public Lancamento converter(LancamentoDTO dto) {
		...
		Usuario usuario = usuarioService
				...
				.orElseThrow(() -> new RegraNegocioException("Usuario não encontrado pelo id!"));
